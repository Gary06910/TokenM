...
var translations = {
  en: {
    "meta.title": "To Know: AI Tools usage at a glance",
    "meta.description": "To Know is a local-first desktop app for live tokens, cost, limits, sessions, and history across 29+ AI coding tools.",
    "meta.ogTitle": "To Know",
    "meta.ogDescription": "Live tokens, cost, limits, sessions, and history across 29+ AI coding tools.",
    "nav.skip": "Skip to content",
    "nav.primary": "Primary",
    "nav.home": "To Know home",
    "nav.language": "Language",
    "nav.github": "GitHub",
    "nav.star": "Star",
    "nav.githubStar": "Star To Know on GitHub",
    ...
    "hero.preview": "Preview of the To Know Home dashboard",
    ...
    "cta.download.aria.generic": "Download the latest To Know release",
    "cta.download.aria.mac": "Download To Know for macOS",
    "cta.download.aria.windows": "Download To Know for Windows",
    "cta.download.aria.linux": "Download To Know for Linux",
    ...
    "feature.lede": "Walk through four of the nine real To Know views, or choose a view directly.",
    "feature.views": "To Know product views",
    ...
    "dash.lede": "Turn on opt-in history and To Know opens a full dashboard window: a GitHub-style activity heatmap with streaks, plus per-tool and per-model usage stacked over time in bar and K-line views, rolled up across all your devices.",
    "mock.you": "YOU",
    "mock.newest": "↕ Newest",
    ...
    "privacy.body": "To Know syncs only the fields needed to show totals, costs, tool and model breakdowns, and normalized account limit status.",
  ...
  "zh-TW": {
    "meta.title": "To Know：AI Tools 用量一眼看清",
    "meta.description": "To Know 是本地優先的桌面 App，可即時查看 29+ 種 AI coding 工具的 token、成本、限額、session 與歷史。",
    "meta.ogTitle": "To Know",
    ...
    "nav.github": "GitHub",
    "nav.star": "Star",
    "nav.githubStar": "在 GitHub 上為 To Know 加星",
    "nav.sections": "區塊導覽",
    "nav.features": "功能",
    "nav.privacy": "隱私",
    "nav.download": "下載",
    ...
    "hero.preview": "To Know Home dashboard 預覽",
    "hero.periods": "用量期間",
    "cta.download": "下載最新版本",
    ...
    "cta.download.aria.generic": "下載最新版 To Know",
    "cta.download.aria.mac": "下載 macOS 版 To Know",
    "cta.download.aria.windows": "下載 Windows 版 To Know",
    "cta.download.aria.linux": "下載 Linux 版 To Know",
    ...
    "dash.lede": "開啟可選的歷史收集，To Know 會打開完整的 dashboard 視窗：GitHub 風格的活動熱力圖與連續天數，加上隨時間堆疊的各工具、各模型用量，提供長條圖與 K 線兩種檢視，並彙整你所有裝置。",
    "mock.you": "你",
    "mock.newest": "↕ 最新",
    ...
    "privacy.body": "To Know 只同步顯示總量、成本、工具與模型拆分，以及標準化帳戶限制所需的欄位。",
  ...
  "zh-CN": {
    "meta.title": "To Know：AI Tools 用量一眼看清",
    "meta.description": "To Know 是本地优先的桌面 App，可实时查看 29+ 种 AI coding 工具的 token、成本、限额、session 与历史。",
    "meta.ogTitle": "To Know",
    ...
    "nav.github": "GitHub",
    "nav.star": "Star",
    "nav.githubStar": "在 GitHub 上为 To Know 加星",
    "nav.sections": "区块导航",
    "nav.features": "功能",
    "nav.privacy": "隐私",
    "nav.download": "下载",
    ...
    "hero.alsoAvailable": "其他版本",
    "hero.preview": "To Know Home dashboard 预览",
    "hero.periods": "用量期间",
    "cta.download": "下载最新版本",
    ...
    "cta.download.aria.generic": "下载最新版 To Know",
    "cta.download.aria.mac": "下载 macOS 版 To Know",
    "cta.download.aria.windows": "下载 Windows 版 To Know",
    "cta.download.aria.linux": "下载 Linux 版 To Know",
    "cta.github": "查看 GitHub",
    ...
    "dash.lede": "开启可选的历史收集，To Know 会打开完整的 dashboard 窗口：GitHub 风格的活动热力图与连续天数，加上随时间堆叠的各工具、各模型用量，提供柱状图与 K 线两种视图，并汇总你所有设备。",
    "mock.you": "你",
    "mock.newest": "↕ 最新",
    ...
    "privacy.body": "To Know 只同步显示总量、成本、工具与模型拆分，以及标准化账号限制所需的字段。",
